...
// variable to store the time of the last analog read
unsigned long previousMillis = 0;
// interval at which to read the analog value
...
// assume initial direction(positive pwm) is clockwise
